...
def Start_Game(numOfSkeleton, time_limit):
    ...
    if numOfSkeleton == 1:
        ...
        # Characters.YellowObject.drawBox("Box.png",screen,500,100)
    ...
    while running:
        ...
        if keys[pygame.K_SPACE] and player_attack_cooldown == 0:
            ...
            for enemy in enemies:
                if player.hit(enemy):
                    sword_sound = pygame.mixer.Sound("swing-whoosh-weapon-1-189819.mp3")
                    sword_sound.play()
                    enemy.hits += 1 
                    if enemy.hits >= 3:  
                        ...
                        if len(enemies) == 0 and numOfSkeleton == 1:
                            pygame.mixer.stop() 
                            laughing_sound = pygame.mixer.Sound("evil-laugh-49831.mp3")
